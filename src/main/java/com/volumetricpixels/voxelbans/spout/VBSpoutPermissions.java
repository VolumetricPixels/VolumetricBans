...
public class VBSpoutPermissions implements VBPermissions {
    ...
    public static final VBSpoutPermissions perms = new VBSpoutPermissions((VoxelBansSpout) Spout.getEngine().getPluginManager().getPlugin("VoxelBans"));
    
    private VoxelBansSpout plugin;
    
    private VBSpoutPermissions(VoxelBansSpout plugin) {
        this.plugin = plugin;
    }
