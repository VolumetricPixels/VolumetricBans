...
public class Ban implements Deletable {
     ...
     * @param player The player banned
     ...
     * @param admin    The admin who issued the ban
     * @param timeMins How long the ban should last in minutes
     */
     ...
     *
     * @param time Time in minutes the ban will last
     */
     ...
     *
     * @param plugin The VolumetricBans plugin
     * @param jo     The JSONObject to use for creation
     *
     * @return A Ban created from the JSONObject
     *
     * @throws DataLoadException When there is a problem parsing the JSONObject
     */
