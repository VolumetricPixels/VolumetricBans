...
public final class Mute implements Deletable {
	 ...
	 */
	public Mute(final VolumetricBans plugin, final String player,
	 ...
	 *            Global
	 */
	private Mute(final VolumetricBans plugin, final String player,
	 ...
	 */
	public static Mute fromJSONObject(final VolumetricBans plugin,
		...
		try {
			...
			throw new DataLoadException(
					"Could not create a Mute object from given JSONObject", e);
		}
	}
}
