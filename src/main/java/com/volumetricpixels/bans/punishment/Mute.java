...
public class Mute implements Deletable {
     ...
     * Mute constructor
     *
     * @param plugin   The VolumetricMutes plugin
     * @param player   The muted player
     * @param reason   The mute reason
     * @param admin    The admin who issued the mute
     * @param timeMins How long the mute should last in minutes
     */
     ...
     *
     * @param reason The new mute reason
     */
     ...
     *
     * @param time Time in minutes the mute will last
     */
     ...
     * @param jo     The JSONObject to use the data from
     *
     * @return A Mute created from given JSONObject
     *
     * @throws DataLoadException When we fail to parse the JSONObject
     */
