...
public final class APIRequestHandler {
	 ...
	 */
	public JSONObject submitRequest(final Map<String, String> postData)
			throws DataRetrievalException {
		String urlReq = null;
		String json = null;
...
//      }
	 ...
	 *             When we fail to retrieve data
	 */
	private String doPerformRequest(final String data)
			throws DataRetrievalException {
		try {
	 ...
	 */
	private String parsePostItems(final Map<String, String> postData)
			throws DataRetrievalException {
		String data = null;
		try {
			...
			throw new DataRetrievalException("System does not support UTF-8!",
					e);
		}
	}
