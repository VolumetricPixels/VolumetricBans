...
public class APIRequestHandler {
     ...
     * @param actionCategory This APIRequestHandler's category
     */
     ...
     *
     * @throws DataRetrievalException When we fail to retrieve data
     */
     ...
     *
     * @param jsonText A String of JSON data
     *
     * @return A JSONObject created from the jsonText
     *
     * @throws DataRetrievalException When a JSONObject can't be created
     */
     ...
     *
     * @param data Post data to submit
     *
     ...
     *
     * @param postData A Map of data to parse
     *
     * @return A UTF-8 string of post data
     *
     * @throws DataRetrievalException When the system doesn't support UTF-8
     */
