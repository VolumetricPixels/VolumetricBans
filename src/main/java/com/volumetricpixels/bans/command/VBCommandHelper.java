...
public class VBCommandHelper {
     ...
     *
     * @param sender The CommandSource to send the help to
     * @param args   The command arguments (if any)
     *
     * @throws CommandException When there is a lack of good input
     */
     ...
     *
     * @param chatSections The List of ChatSections to turn into raw args
     *
