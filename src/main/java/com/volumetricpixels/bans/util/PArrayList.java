 ...
 *
 * @param <T> The type to be stored in the ArrayList
 */
public class PArrayList<T> extends ArrayList<T> {
     ...
     *
     * @param plugin VolumetricBans plugin instance for event calling
     */
     ...
     * to / removals from the ArrayList
     *
     * @param callEvents Whether events should be called
     */
