...
public final class Utilities {
	 ...
	 */
	public static boolean isPermaGlobalBanned(final APIRequestHandler handler,
			final String playerName) throws DataRetrievalException {
		...
		try {
			...
			throw new DataRetrievalException(
					"Could not check if player was permabanned globally!", e);
		}
	}
	...
	public static String[] genConfigHeader(final VolumetricBans vb) {
		final List<String> lines = new ArrayList<String>();
		final String version = vb.getDescription().getVersion();
		lines.add("VolumetricBans " + version + " - "
				+ VolumetricBans.WEBSITE_URL);
