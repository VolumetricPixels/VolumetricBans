...
public class APIRequestUtil {
     ...
     *
     * @param json The JSONObject to get the Map from
     *
     ...
     * APIRequestHandler
     *
     * @param handler    The APIRequestHandler to use. This should be the player type
     * @param playerName The name of the player to check for a global permaban
     *
     * @return Whether the given player is globally permabanned
     *
     * @throws DataRetrievalException When something goes wrong retrieving or parsing data
     */
