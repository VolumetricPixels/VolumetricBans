...
public final class PunishmentStorage {
	...
	public void saveBans() throws StorageException {
		...
		try {
			...
			throw new StorageException(
					"Error writing bans to file! A backup of your old bans should be found in /plugins/VolumetricBans/data/!",
					e);
		}
	}
	...
	public void saveMutes() throws StorageException {
		...
		try {
			...
			throw new StorageException(
					"Error writing mutes to file! A backup of your old mutes should be found in /plugins/VolumetricBans/data/!",
					e);
		}
	}
