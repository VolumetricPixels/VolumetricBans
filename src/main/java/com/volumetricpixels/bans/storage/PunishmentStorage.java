...
public class PunishmentStorage {
     ...
     * instance
     *
     * @param plugin The VolumetricBans plugin instance
     */
     ...
     *
     * @throws StorageException  When there are problems with reading or parsing the file
     * @throws DataLoadException When there is a problem creating a ban from a JSONObject
     */
     ...
     *
     * @throws StorageException  When there are problems with reading or parsing the file
     * @throws DataLoadException When there is a problem creating a mute from a JSONObject
     */
     ...
     *
     * @throws StorageException When there are issues writing to the file
     */
