...
public class JSONFileHandler {
     ...
     *
     * @throws StorageException When we cannot initialise the BufferedWriter
     */
     ...
     *
     * @throws StorageException When we cannot flush or close the BufferedWriter
     */
     ...
     *
     * @param jO The JSONObject to write to the file
     *
     * @throws StorageException When we fail to write the JSONObject
     */
     ...
     *
     * @throws StorageException When we fail to create the BufferedReader
     */
     ...
     *
     * @throws StorageException When we fail to close the BufferedReader
     */
     ...
     *
     * @throws StorageException When we fail to read or parse the line
     */
     ...
     *
     * @throws StorageException When we fail to back up the file
     */
     ...
     *
     * @throws StorageException When we cannot create the file
     */
